...
use gluex_rs::ccdb::{CCDBResult, context::CCDBContext, database::CCDB, models::ColumnMeta};
use gluex_rs::core::{GlueXCoreError, parsers::parse_timestamp};
...
fn fetch_respects_runs_variations_and_timestamps() -> CCDBResult<()> {
    ...
    let first_available = parse_timestamp("2013-02-22 13:40:35")?;
